...
<body>
    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, Abdulmuiz KPR</div></a>
          ...
          <ul class="sidebar-menu">
            ...
            <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
              <a href="https://getstisla.com/docs" class="btn btn-primary btn-lg btn-block btn-icon-split">
                <i class="fas fa-rocket"></i> SIA UMB
              </a>
            </div>
        </aside>
      </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Design By <a href="#">Abdulmuiz Kurnia Pungki Rahayu - 41518320001 - Teknik Informatika - Universitas Mercu Buana</a>
        </div>
  ...
  <script src="<?=base_url()?>/chartjs/dist/Chart.min.js"></script>
