<?= $this->extend('layout/backend') ?>
  ...
  <title>AKUNTANSI WEB &mdash; AKUN1</title>
                      ...
                      <table class="table table-striped table-md" id="myTable">
                        ...
                        <tr>
                          ...
                          <td class="text-center" style="width:20%" >
                            ...
                            <button class="btn btn-danger btn-small" data-confirm="Hapus Data! | Apakah Anda Yakin ?" data-confirm-yes="hapus(<?=$value->id_akun1 ?>)"><i class="fas fa-trash"> Delete </i></button>
